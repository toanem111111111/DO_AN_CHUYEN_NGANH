		...
		<?php
			...
			<?php
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="file" class="form-control" name="hinhanh"><br>
					<label>Giá</label>
					<input type="number" class="form-control" name="giasanpham" placeholder="Giá sản phẩm" min="1" max="1000000000"><br>
					<label>Giá khuyến mãi</label>
					<input type="number" class="form-control" name="giakhuyenmai" placeholder="Giá khuyến mãi" min="1" max="1000000000"><br>
					<label>Số lượng</label>
					<input type="number" class="form-control" name="soluong" placeholder="Số lượng" min="1" max="500"> <br>
					<label>Mô tả</label>
