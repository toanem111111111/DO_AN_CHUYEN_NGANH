...
?> 
 ...
 <?php
	if(isset($_GET['search_button'])){
		...
		$sql_product = mysqli_query($con,"SELECT * FROM tbl_sanpham WHERE sanpham_name LIKE '%$tukhoa%' ORDER BY sanpham_id DESC LIMIT $begin,3");		
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					...
					<div class="wrapper">
						...
						<?php
						//Phân Trang tìm Kím.
				//gán biến bằng câu truy vấn
				$sql_trang = mysqli_query($con,"SELECT * FROM tbl_sanpham");
				//gán biến = hàm mysqli_num_rows() sẽ thực hiện truy vấn với csdl
                //kết nối mysql là $mysqli, câu truy vấn sql_pro
				...
				<ul class="list_trang">
					...
					?>
						...
						<a href="index.php?quanly=timkiem&search_product=<?php echo $_GET['search_product']?>&search_button=1&trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					<?php
					} 
					?>
