				...
				<div class="modal-body">
					<form action="#" method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="email_login" required="vui lòng nhập mail">
						</div>
						<div class="form-group">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Điện Máy Mới
						</a>
					</h1>
				</div>
				<!-- //logo -->
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="index.php?quanly=timkiem" method="GET">
								<input name="quanly" value="timkiem" hidden >
								...
								<button class="btn my-2 my-sm-0" value="1" name="search_button" type="submit">Tìm kiếm</button>
							</form>
						</div>
						<!-- Tim Kiem -->
						<!-- cart details -->
