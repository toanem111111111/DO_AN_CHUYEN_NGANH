...
<body>
	...
	<!-- nav smooth scroll -->
	<script>
		//bộ quản lý sự kiện cửa jquery
		$(document).ready(function () {
			//tạo một thanh menu sổ xún
			$(".dropdown").hover(
				function () {
...
// chỉ sử dụng các tên lớp duy nhất ngoài paypals.minicarts. Ngoài ra, Thay thế cùng một tên lớp trong css và minicart.min.js
